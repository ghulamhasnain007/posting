...
from app.Linkedin.services import linkedin_callback, linkedin_auth, post_image_to_linkedin, post_text_to_linkedin
from app.utils.linkedin_util import upload_image, upload_local_image
import shutil
...
def post_image(image_url: str = Query(...), text: str = Query(...)):
    ...
    asset_urn = upload_image(image_url, author_id)
...
@router.post("/post/profile/image", tags=["Linkedin"])
def post_image(image_url: str = Query(...), text: str = Query(...)):
